...
export default function Homepage() {
  return (
    <div>
      <DisplayLayout>
        <>
          <div className="hero h-screen bg-black flex items-center px-5 md:px-20">
            <div className="md:w-[60%] md:mt-32">
              <div className="px-7 py-3 mb-5 font-medium text-sm bg-white rounded-full w-max">See How We Impact</div>
              <h3 className="text-white text-4xl md:text-6xl font-medium leading-tight md:leading-tight mb-3 md:mb-5">Driving Agricultural Evolution with Innovation</h3>
              <p className="md:w-[80%] text-sm md:text-base mb-8 md:leading-loose leading-loose text-white opacity-90">
              ...
              <Link href="" className="block text-sm md:text-base w-max bg-primary rounded-full py-4 px-10 text-center text-black font-medium">
                See How We Impact
              </Link>
            </div>
          </div>
          <div className="px-5 md:px-20 mt-24">
            ...
            <div className="flex flex-col md:grid grid-cols-1/2 mt-14 gap-5 md:gap-20 items-start">
              <div className="flex gap-2 items-center">
                ...
                <p className="md:leading-relaxed leading-relaxed text-base md:text-xl">Who are we at NovaTraders?</p>
              </div>
              <div>
                ...
                <button className="mt-10 text-sm md:text-base border-2 border-solid border-black text-black py-4 px-8 rounded-full text-base gap-3 flex items-center">Click here to learn more <HiArrowTrendingUp className="text-3xl" /></button>
              </div>
            </div>
            <div className="flex flex-col md:grid md:grid-cols-4 gap-5 mt-10 md:mt-20">
              <Image src={_1} alt="nkwn" className="hidden md:block rounded-xl md:h-full object-fit" />
              ...
              <Image src={_2} alt="nkwn" className="hidden md:block rounded-xl" />
          ...
          <div className="bg-black mt-20 md:mt-32 px-5 md:px-20 py-20 md:py-32">
            <div className="text-center md:text-left md:w-[75%]">
              <div className="px-5 py-3 mb-5 font-medium text-sm bg-primary rounded-full w-max">See How We Impact</div>
              <h3 className="text-white text-3xl md:text-5xl font-medium leading-snug md:leading-snug mb-5">Find A Variety Of The Latest Information About Agriculture With Novatraders.</h3>
              <p className="text-sm md:text-lg md:leading-loose leading-loose text-white opacity-80">
          ...
          <div className="mt-20 md:mt-32 px-5 md:px-20 flex flex-col-reverse md:grid gap-14 grid-cols-2">
            <div>
              <div>
                <h3 className="text-3xl md:text-5xl md:w-[90%] font-bold mb-3 md:leading-tight leading-tight capitalise">Improving Farming With Innovative Ideas For The Future.</h3>
                <p className="text-sm md:text-base md:leading-loose leading-loose">
                  Sura Vision - is a trailblazing investment firm that envisions a future of innovation and transformative impact. Our journey began with a passionate group of visionary investors who saw the immense potential in supporting startups.
                </p>
          ...
          <div className="py-32 px-5 md:px-0 bg-[#0B1416] mt-20 md:mt-32 flex items-center justify-center text-center">
            <div className="md:w-[60%] mx-auto">
              <h3 className="text-3xl md:text-5xl font-bold text-white mb-8 leading-relaxed md:leading-relaxed">Get The Latest NovaTraders Updates By Subscribing To Our Newsletter.</h3>
              <div className="form-input bg-white rounded-full flex px-1 w-[90%] md:w-[70%] mx-auto py-1">
